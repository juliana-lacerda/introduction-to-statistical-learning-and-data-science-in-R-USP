...
novas_pessoas <- data.frame(x = c(12, 9, 16))
predict(fit, novas_pessoas)
...
round(predicao, 2) # arrendonda os valores para 3 casas decimais
...
# armazena os dados em um data frame
dados <- data.frame(x1 = anos_estudo, 
                    x2 = curso_aprendizagem, 
                    y = salario)
...
# TAREFA: obter as estimativas do modelo de regressao linear
# manualmente
